...
export default function Profile() {
  ...
  const hasActiveSubscription = useMemo(() => {
    return user?.subscriptionPlanId && user.subscriptionPlanId !== "undefined" && subscriptionInfo;
  }, [user?.subscriptionPlanId, subscriptionInfo]);

  const [activeSection, setActiveSection] = useState<ActiveSection>(() => {
    return hasActiveSubscription ? 'overview' : 'profiles';
  });

  useMemo(() => {
    if (!hasActiveSubscription && activeSection !== 'profiles') {
  ...
  const handleCancelSubscription = async () => {
    try {
      ...
      showToast.success("Assinatura cancelada", "Sua assinatura foi cancelada com sucesso.");
      ...
      showToast.error("Erro", "Não foi possível cancelar a assinatura. Tente novamente.");
    } finally {
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="p-4 lg:p-8">
                ...
                <p className="text-gray-600 mb-6 lg:mb-8">
                  {hasActiveSubscription ? "Detalhes da Assinatura" : "Informações do Perfil"}
                </p>

                {activeSection === 'overview' && hasActiveSubscription && (
                ...
                {activeSection === 'membership' && hasActiveSubscription && (
                  <div className="space-y-4 lg:space-y-6">
                    <div className="bg-white border border-gray-200 rounded-lg p-4 lg:p-6">
                      ...
                      <div className="mt-6 flex flex-col sm:flex-row gap-3">
                        ...
                        <Button 
                          ...
                          className="flex items-center justify-center gap-2 px-4 py-2 bg-red-600 font-medium text-white rounded-lg hover:bg-red-700 transition-colors text-sm lg:text-base"
                        >
