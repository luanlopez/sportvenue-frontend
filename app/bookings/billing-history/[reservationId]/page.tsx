    ...
    return (
      <div className="min-h-screen bg-white py-10">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-2xl font-bold text-slate-900 mb-2">Histórico de Cobrança</h1>
          <p className="text-base text-slate-500 mb-8">Acompanhe o status e os detalhes dos pagamentos desta reserva.</p>
                          ...
                          <table className="min-w-[700px] w-full text-sm border-collapse">
                            ...
                            <tbody>
                              {invoices.data.map((invoice: Invoice, index: number) => {
                                ...
                                return (
                                  <tr key={invoice._id || index} className="hover:bg-slate-50 transition-colors">
                ...
                <div className="divide-y divide-gray-100">
                  ...
                  {isPending && (
                    <div className="px-5 py-4">
                                          <Button
                      onClick={() => handlePaymentTypeSelect("PAGO_PRESENCIALMENTE")}
        ...
        <div className="container mx-auto px-4 mt-8 mb-10">
          ...
          <h3 className="text-primary-50 font-semibold text-base mb-2 flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 mr-2 text-primary-50">
          ...
          <p className="text-sm text-primary-50/80 mt-2">
            Para mais informações sobre pagamentos e políticas de cancelamento, consulte nossos <a href="#" className="text-primary-50 underline font-medium">Termos e Condições</a>.
          </p>
        </div>
        </div>
